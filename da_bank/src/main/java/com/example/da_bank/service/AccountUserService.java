...
public class AccountUserService {
    ...
    public AccountUserService(AccountUserRepository accountUserRepository, BankAccountRepository bankAccountRepository) {
    ...
    public String createUserAccount (int customerNumber, String dob, String firstname, String lastname, String password, String username, String email, String phone_number) throws RuntimeException {
        ...
        if (existingUserCN != null || existingUserUN != null){
            ...
            accountUserRepository.createUserAccount(customerNumber, dob, firstname, lastname, password, username, email, phone_number);
